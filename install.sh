...
wget -O /etc/squid3/squid.conf "https://github.com/hiphop2531/PritunlThongchai/blob/master/squid.conf" 
...
wget -O /etc/nginx/nginx.conf "https://github.com/hiphop2531/PritunlThongchai/blob/master/nginx.conf"
mkdir -p /home/vps/public_html
echo "<pre>Setup by MKSSHVPN </pre>" > /home/vps/public_html/index.html
echo "<?php phpinfo(); ?>" > /home/vps/public_html/info.php
wget -O /etc/nginx/conf.d/vps.conf "https://github.com/hiphop2531/PritunlThongchai/blob/master/vps.conf"
